...
def user_monitor(username):
    try:
        ...
        usname = username
        sql = "select a.user_id ,SUM(a.user_op_type = 0) as loginNum, b.user_name  from user_access_log a LEFT JOIN sys_user b on a.user_id=b.user_id"
        sql+= " WHERE b.user_name = '{0}' ".format(usname)
